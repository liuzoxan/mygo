...
var fileDescriptor_08134aea513e0001 = []byte{
	...
	0x05, 0x46, 0x0d, 0xce, 0x20, 0x10, 0x13, 0x21, 0x59, 0x8c, 0x29, 0x69, 0x64, 0xc5, 0xc5, 0x02,
	0x92, 0x14, 0x32, 0xe2, 0x62, 0x01, 0x99, 0x27, 0x24, 0xac, 0x87, 0x30, 0x56, 0x0f, 0x6a, 0xa6,
	0x14, 0x16, 0xc1, 0x62, 0x03, 0xc6, 0x24, 0x36, 0xb0, 0x80, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff,
	0x19, 0x26, 0x40, 0xef, 0x96, 0x00, 0x00, 0x00,
}
...
type EchoClient interface {
	Echo(ctx context.Context, in *EchoReq, opts ...grpc.CallOption) (Echo_EchoClient, error)
}
...
func (c *echoClient) Echo(ctx context.Context, in *EchoReq, opts ...grpc.CallOption) (Echo_EchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[0], "/echo_proto.Echo/echo", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *echoEchoClient) Recv() (*EchoRes, error) {
	m := new(EchoRes)
...
type EchoServer interface {
	Echo(*EchoReq, Echo_EchoServer) error
}
...
func _Echo_Echo_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(EchoServer).Echo(m, &echoEchoServer{stream})
}
...
func (x *echoEchoServer) Send(m *EchoRes) error {
